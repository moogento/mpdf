...
abstract class BlockTag extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if ($this->mpdf->tableLevel) {
			...
			if (isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]) && isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s']) && $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s'] > 0 && !$this->mpdf->nestedtablejustfinished) {
